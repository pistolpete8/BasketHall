...
namespace KosSala.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ActionResult IzmeniPod(string id)
        {
            if (id == null)
               {
            ...
            public async Task<ActionResult> IzmeniPod([Bind] ApplicationUser applicationUser)
            {
                if (ModelState.IsValid)
                {
                string idKor = User.Identity.GetUserId();
                var kor = db.Users.Where(s => s.Id == idKor).FirstOrDefault();
                kor.Ime = applicationUser.Ime;
                kor.Prezime = applicationUser.Prezime;
                kor.UserName = applicationUser.UserName;
                kor.Opis = applicationUser.Opis;
                kor.Email = applicationUser.Email;
                kor.PhoneNumber = applicationUser.PhoneNumber;
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                return RedirectToAction("ProfileAcc", new { Message = ManageMessageId.ChangePasswordSuccess });
            }
            AddErrors(result);
            return View(model);
        }
        ...
        public async Task<ActionResult> LinkLoginCallback()
        {
            ...
            return result.Succeeded ? RedirectToAction("ProfileAcc") : RedirectToAction("ProfileAcc", new { Message = ManageMessageId.Error });
        }
